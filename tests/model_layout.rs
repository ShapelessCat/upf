...
fn model_layout_uses_non_mod_rs_and_dedicated_top_level_type_modules() {
    ...
    for path in [
        ...
        "src/model/common.rs",
        "src/model/internal/scalar_text.rs",
        "src/model/internal/numeric_values.rs",
        "src/model/internal/numeric_section.rs",
        "src/model/internal/tagged_children.rs",
...
fn model_files_define_parent_items_before_child_items() {
    ...
    assert_item_order(
        ...
        &[
            ...
            "pub use info::*;",
            "pub use header::*;",
            "pub use internal::{Numbered, NumberedTag};",
        ],
    );
    assert_item_order(
