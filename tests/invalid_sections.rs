...
#[test]
fn validation_errors_are_accumulated_for_multiple_reachable_violations() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="O" pseudo_type="PAW" relativistic="full"
                 is_ultrasoft="T" is_paw="T" is_coulomb="F"
                 has_so="T" has_wfc="T" has_gipaw="T" paw_as_gipaw="F"
                 core_correction="T" with_metagga_info="T"
                 functional="PBE"
                 z_valence="6.0" total_psenergy="-1.0"
                 l_max="1" mesh_size="2" number_of_wfc="2" number_of_proj="2" />
      <PP_MESH mesh="1">
        <PP_R>0.0</PP_R>
      ...
      <PP_SPIN_ORB>
        <PP_RELWFC.1 els="2S" nn="2" lchi="0" jchi="0.5" oc="2.0" />
      </PP_SPIN_ORB>
      <PP_GIPAW gipaw_data_format="2">
        <PP_GIPAW_CORE_ORBITALS number_of_core_orbitals="1">
          <PP_GIPAW_CORE_ORBITAL.2 index="1" label="1S" n="1.0" l="0.0">0.8</PP_GIPAW_CORE_ORBITAL.2>
    ...
    assert!(message.contains("PP_MESH declares mesh 1 but PP_HEADER mesh_size is 2"));
    assert!(message.contains("PP_HEADER enables core correction but PP_NLCC is missing"));
    assert!(
        message
            .contains("PP_HEADER declares 2 projectors but PP_NONLOCAL contains 1 PP_BETA entries")
    );
    assert!(message.contains("PP_GIPAW_ORBITALS is missing"));
}
...
#[test]
fn gipaw_requires_core_orbitals_subtree() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="Si" pseudo_type="NC" relativistic="scalar"
                 is_ultrasoft="F" is_paw="F" is_coulomb="F"
                 has_so="F" has_wfc="F" has_gipaw="T" paw_as_gipaw="T" core_correction="F"
                 functional="PBE"
                 z_valence="4.0" total_psenergy="-5.0"
                 wfc_cutoff="30.0" rho_cutoff="120.0"
                 l_max="1" l_max_rho="2" l_local="1"
    ...
    let err = from_str(xml).unwrap_err();
    assert!(err.to_string().contains("PP_GIPAW_CORE_ORBITALS"));
}

#[test]
fn gipaw_requires_valence_orbitals_subtree_when_not_paw_as_gipaw() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="At" pseudo_type="NC" relativistic="full"
                 is_ultrasoft="F" is_paw="F" is_coulomb="F"
                 has_so="T" has_wfc="F" has_gipaw="T" paw_as_gipaw="F" core_correction="F"
                 functional="PBE"
...
#[test]
fn gipaw_requires_vlocal_subtree_when_not_paw_as_gipaw() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="At" pseudo_type="NC" relativistic="full"
      ...
      <PP_GIPAW gipaw_data_format="2">
        <PP_GIPAW_CORE_ORBITALS number_of_core_orbitals="0"></PP_GIPAW_CORE_ORBITALS>
        <PP_GIPAW_ORBITALS number_of_valence_orbitals="0"></PP_GIPAW_ORBITALS>
      </PP_GIPAW>
    </UPF>
    "#;

    let err = from_str(xml).unwrap_err();
    assert!(err.to_string().contains("PP_GIPAW_VLOCAL"));
}
...
fn projector_declared_size_attribute_is_ignored() {
    ...
    assert_eq!(
        doc.nonlocal.as_ref().unwrap().betas[0].value.values,
        vec![0.1]
    );
}
...
#[test]
fn full_wfc_family_counts_must_match_number_of_proj() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 ...
                 functional="PBE"
                 z_valence="6.0" total_psenergy="-1.0"
                 l_max="1" mesh_size="1" number_of_wfc="1" number_of_proj="2" />
      <PP_MESH mesh="1">
        <PP_R type="real" size="1">0.0</PP_R>
        <PP_RAB type="real" size="1">0.1</PP_RAB>
      </PP_MESH>
      ...
      <PP_NONLOCAL>
        ...
        <PP_AUGMENTATION q_with_l="T" nqf="0" nqlc="1">
          <PP_Q type="real" size="4">0.0 0.0 0.0 0.0</PP_Q>
        </PP_AUGMENTATION>
      </PP_NONLOCAL>
      <PP_PSWFC>
        <PP_CHI.1 label="2S" l="0">0.5</PP_CHI.1>
      ...
      <PP_PAW paw_data_format="2">
        <PP_OCCUPATIONS type="real" size="2">2.0 0.0</PP_OCCUPATIONS>
        <PP_AE_NLCC type="real" size="1">0.0</PP_AE_NLCC>
        <PP_AE_VLOC type="real" size="1">0.1</PP_AE_VLOC>
      </PP_PAW>
      <PP_RHOATOM type="real" size="1">0.2</PP_RHOATOM>
    </UPF>
    "#;
    ...
    let err = from_str(xml).unwrap_err();
    assert!(err.to_string().contains("PP_FULL_WFC"));
    assert!(err.to_string().contains("number_of_proj"));
}

#[test]
fn full_wfc_section_number_of_wfc_is_not_a_count_contract() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="valid"
                 element="O" pseudo_type="PAW" relativistic="scalar"
                 is_ultrasoft="F" is_paw="T" is_coulomb="F"
                 has_so="F" has_wfc="T" has_gipaw="F" paw_as_gipaw="F"
                 core_correction="F" with_metagga_info="F"
    ...
    let doc = from_str(xml).unwrap();
    assert_eq!(doc.full_wfc.as_ref().unwrap().number_of_wfc, Some(2));
    assert_eq!(doc.full_wfc.as_ref().unwrap().ae_wfc.len(), 1);
    assert_eq!(doc.full_wfc.as_ref().unwrap().ps_wfc.len(), 1);
}
...
#[test]
fn paw_requires_occupations_subtree() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="O" pseudo_type="PAW" relativistic="scalar"
...
#[test]
fn paw_requires_ae_nlcc_subtree() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="O" pseudo_type="PAW" relativistic="scalar"
...
#[test]
fn paw_requires_ae_vloc_subtree() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="O" pseudo_type="PAW" relativistic="scalar"
    ...
    let err = from_str(xml).unwrap_err();
    assert!(err.to_string().contains("PP_AE_VLOC"));
}
...
fn augmentation_vector_lengths_must_match_derived_qe_sizes() {
    ...
    <UPF version="2.0.1">
      ...
      <PP_PAW paw_data_format="2">
        ...
        <PP_AE_NLCC>0.0 0.1</PP_AE_NLCC>
        <PP_AE_VLOC>0.2 0.3</PP_AE_VLOC>
      </PP_PAW>
      <PP_RHOATOM>0.2 0.3</PP_RHOATOM>
    </UPF>
    "#;
...
fn gipaw_mesh_sized_sections_must_match_mesh_size() {
    ...
    <UPF version="2.0.1">
      ...
      <PP_GIPAW gipaw_data_format="2">
        ...
        <PP_GIPAW_VLOCAL>
          <PP_GIPAW_VLOCAL_AE>0.7 0.8</PP_GIPAW_VLOCAL_AE>
          <PP_GIPAW_VLOCAL_PS>0.9 1.0</PP_GIPAW_VLOCAL_PS>
        </PP_GIPAW_VLOCAL>
      </PP_GIPAW>
    </UPF>
    "#;
...
#[test]
fn gipaw_core_orbital_tag_index_must_match_index_attribute() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="At" pseudo_type="NC" relativistic="full"
      ...
      <PP_LOCAL>1.0</PP_LOCAL>
      <PP_RHOATOM>0.2</PP_RHOATOM>
      <PP_TAUMOD>0.3</PP_TAUMOD>
      <PP_TAUATOM>0.4</PP_TAUATOM>
      <PP_SPIN_ORB />
      <PP_GIPAW gipaw_data_format="2">
        <PP_GIPAW_CORE_ORBITALS number_of_core_orbitals="1">
          <PP_GIPAW_CORE_ORBITAL.2 index="1" label="1S" n="1.0" l="0.0">0.8</PP_GIPAW_CORE_ORBITAL.2>
        ...
        <PP_GIPAW_ORBITALS number_of_valence_orbitals="0"></PP_GIPAW_ORBITALS>
        <PP_GIPAW_VLOCAL>
          <PP_GIPAW_VLOCAL_AE>0.7</PP_GIPAW_VLOCAL_AE>
          <PP_GIPAW_VLOCAL_PS>0.8</PP_GIPAW_VLOCAL_PS>
        </PP_GIPAW_VLOCAL>
      </PP_GIPAW>
    </UPF>
    "#;
    ...
    let err = from_str(xml).unwrap_err();
    assert!(err.to_string().contains("PP_GIPAW_CORE_ORBITAL.2"));
    assert!(err.to_string().contains("index"));
}

#[test]
fn gipaw_valence_orbital_tag_index_must_match_index_attribute() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="At" pseudo_type="NC" relativistic="full"
      ...
      <PP_GIPAW gipaw_data_format="2">
        <PP_GIPAW_CORE_ORBITALS number_of_core_orbitals="0"></PP_GIPAW_CORE_ORBITALS>
        <PP_GIPAW_ORBITALS number_of_valence_orbitals="1">
          <PP_GIPAW_ORBITAL.3 index="1" label="2P" l="1" cutoff_radius="1.2">
            <PP_GIPAW_WFS_AE>0.5</PP_GIPAW_WFS_AE>
            <PP_GIPAW_WFS_PS>0.6</PP_GIPAW_WFS_PS>
          </PP_GIPAW_ORBITAL.3>
        </PP_GIPAW_ORBITALS>
        <PP_GIPAW_VLOCAL>
          <PP_GIPAW_VLOCAL_AE>0.7</PP_GIPAW_VLOCAL_AE>
    ...
    let err = from_str(xml).unwrap_err();
    assert!(err.to_string().contains("PP_GIPAW_ORBITAL.3"));
    assert!(err.to_string().contains("index"));
}

#[test]
fn gipaw_valence_orbital_requires_index_attribute() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="At" pseudo_type="NC" relativistic="full"
      ...
      <PP_GIPAW gipaw_data_format="2">
        <PP_GIPAW_CORE_ORBITALS number_of_core_orbitals="0"></PP_GIPAW_CORE_ORBITALS>
        <PP_GIPAW_ORBITALS number_of_valence_orbitals="1">
          <PP_GIPAW_ORBITAL.1 label="2P" l="1" cutoff_radius="1.2">
            <PP_GIPAW_WFS_AE>0.5</PP_GIPAW_WFS_AE>
            <PP_GIPAW_WFS_PS>0.6</PP_GIPAW_WFS_PS>
          </PP_GIPAW_ORBITAL.1>
        </PP_GIPAW_ORBITALS>
    ...
    let err = from_str(xml).unwrap_err();
    assert!(err.to_string().contains("PP_GIPAW_ORBITAL.1"));
    assert!(err.to_string().contains("@index"));
}
...
fn q_with_l_true_rejects_qij_naming() {
    ...
    <UPF version="2.0.1">
      ...
      <PP_NONLOCAL>
        ...
        <PP_AUGMENTATION q_with_l="T" nqf="0" nqlc="1">
          <PP_Q type="real" size="1">0.0</PP_Q>
          <PP_QIJ.1.1 first_index="1" second_index="1" composite_index="1">0.2</PP_QIJ.1.1>
        </PP_AUGMENTATION>
      </PP_NONLOCAL>
      <PP_RHOATOM type="real" size="1">0.2</PP_RHOATOM>
    </UPF>
...
#[test]
fn qij_rejects_angular_momentum_attribute() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="Na" pseudo_type="USPP" relativistic="scalar"
      ...
      <PP_NONLOCAL>
        ...
        <PP_AUGMENTATION q_with_l="F" nqf="0" nqlc="1">
          <PP_Q>0.0</PP_Q>
          <PP_QIJ.1.1 composite_index="1" angular_momentum="0">0.2</PP_QIJ.1.1>
        </PP_AUGMENTATION>
      </PP_NONLOCAL>
      <PP_RHOATOM>0.2</PP_RHOATOM>
    </UPF>
    ...
    let err = from_str(xml).unwrap_err();
    assert!(err.to_string().contains("PP_QIJ.1.1"));
    assert!(err.to_string().contains("angular_momentum"));
}

#[test]
fn qijl_requires_matching_angular_momentum_attribute() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="Na" pseudo_type="USPP" relativistic="scalar"
      ...
      <PP_NONLOCAL>
        ...
        <PP_AUGMENTATION q_with_l="T" nqf="0" nqlc="1">
          <PP_Q>0.0</PP_Q>
          <PP_QIJL.1.1.0 composite_index="1" angular_momentum="1">0.2</PP_QIJL.1.1.0>
        </PP_AUGMENTATION>
      </PP_NONLOCAL>
      <PP_RHOATOM>0.2</PP_RHOATOM>
    </UPF>
...
#[test]
fn qijl_requires_angular_momentum_attribute() {
    let xml = r#"
    <UPF version="2.0.1">
      <PP_HEADER generated="unit" author="tester" date="2026-04-03" comment="invalid"
                 element="Na" pseudo_type="USPP" relativistic="scalar"
      ...
      <PP_NONLOCAL>
        ...
        <PP_AUGMENTATION q_with_l="T" nqf="0" nqlc="1">
          <PP_Q>0.0</PP_Q>
          <PP_QIJL.1.1.0 composite_index="1">0.2</PP_QIJL.1.1.0>
        </PP_AUGMENTATION>
      </PP_NONLOCAL>
      <PP_RHOATOM>0.2</PP_RHOATOM>
    </UPF>
