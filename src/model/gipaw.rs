...
pub struct PpGipaw {
    ...
    #[serde(rename = "PP_GIPAW_CORE_ORBITALS")]
    pub core_orbitals: GipawCoreOrbitals,
...
pub struct GipawOrbital {
    ...
    #[serde(rename = "@n", deserialize_with = "deserialize_f64")]
    pub n: f64,
...
pub struct GipawValenceOrbital {
    ...
    #[serde(rename = "@cutoff_radius", deserialize_with = "deserialize_f64")]
