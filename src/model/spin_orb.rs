...
use super::internal::{Numbered, NumberedTag, Tagged, deserialize_f64, deserialize_opt_f64};
...
pub struct PpRelWfc {
    ...
    #[serde(rename = "@jchi", deserialize_with = "deserialize_f64")]
    pub jchi: f64,
    /// Occupation.
    #[serde(
        rename = "@oc",
...
pub struct PpRelBeta {
    ...
    /// Total angular momentum.
    #[serde(rename = "@jjj", deserialize_with = "deserialize_f64")]
    pub jjj: f64,
}
